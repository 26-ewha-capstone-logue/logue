...
export const DATA_SOURCE_MESSAGES = {
  ...
  detailInvalid: '올바르지 않은 데이터 소스입니다.',
  detailLoading: '데이터 소스를 불러오는 중입니다.',
  detailLoginRequired: '로그인 후 데이터 소스를 확인할 수 있습니다.',
  detailLoadFailed: '데이터 소스를 불러오지 못했습니다.',
  previewTableEmpty: '미리보기 데이터가 없습니다.',
  previewTableRowEmpty: '표시할 행이 없습니다.',
